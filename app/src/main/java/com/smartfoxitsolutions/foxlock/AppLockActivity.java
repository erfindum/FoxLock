...
import com.smartfoxitsolutions.foxlock.dialogs.NotificationPermissionDialog;
import com.smartfoxitsolutions.foxlock.dialogs.RecommendedAppsAlertDialog;
import com.smartfoxitsolutions.foxlock.dialogs.StartAppLockDialog;
import com.smartfoxitsolutions.foxlock.services.GetPaletteColorService;
import com.smartfoxitsolutions.foxlock.services.NotificationLockService;
...
public class AppLockActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        appLockModel = AppLockModel.getInstance();
        appLockModel.setUpModel(getSharedPreferences(AppLockModel.APP_LOCK_PREFERENCE_NAME,MODE_PRIVATE));
