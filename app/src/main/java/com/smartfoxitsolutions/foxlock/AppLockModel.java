...
public class AppLockModel {
    ...
    private Gson gson;
    private static AppLockModel appLockModelInstance;

    private AppLockModel(){

    }

    public static AppLockModel getInstance(){
        if(appLockModelInstance == null){
            appLockModelInstance = new AppLockModel();
        }
        return appLockModelInstance;
    }

    public void setUpModel(SharedPreferences sharedPreferences){
