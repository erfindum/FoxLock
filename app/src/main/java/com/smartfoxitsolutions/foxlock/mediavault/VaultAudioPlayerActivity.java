package com.smartfoxitsolutions.foxlock.mediavault;
...
import com.smartfoxitsolutions.foxlock.mediavault.dialogs.AudioPlayerDeleteDialog;
import com.smartfoxitsolutions.foxlock.mediavault.dialogs.AudioPlayerUnlockDialog;
...
public class VaultAudioPlayerActivity extends AppCompatActivity {
    ...
    void setActivityBackground(){
       /* GradientDrawable drawable = new GradientDrawable();
        int[] colors = {Color.parseColor("#770828"), Color.parseColor("#840D33")};
